...
from eis1600_tools.mui_handling.yml_handling import create_yml_header
from eis1600_tools.mui_handling.re_patterns import HEADER_END_PATTERN, UID_PATTERN
